...
public static class Draw
{
	...
	{
		SpriteBatch.DrawString(font, text, position.FloorV2(), color);
	}
	...
	{
		SpriteBatch.DrawString(font, text, position.FloorV2(), color, rotation, origin, scale, SpriteEffects.None, 0f);
	}
	...
	public static void TextJustified(SpriteFont font, string text, Vector2 position, Color color, Vector2 justify)
	{
		...
		origin.X *= justify.X;
		origin.Y *= justify.Y;
		SpriteBatch.DrawString(font, text, position.FloorV2(), color, 0f, origin, 1f, SpriteEffects.None, 0f);
	}
	...
	public static void TextJustified(SpriteFont font, string text, Vector2 position, Color color, float scale, Vector2 justify)
	{
		...
		origin.X *= justify.X;
		origin.Y *= justify.Y;
		SpriteBatch.DrawString(font, text, position.FloorV2(), color, 0f, origin, scale, SpriteEffects.None, 0f);
	}
	...
	public static void OutlineTextCentered(SpriteFont font, string text, Vector2 position, Color color, float scale)
	{
		...
		for (int i = -1; i < 2; i++)
		{
			for (int j = -1; j < 2; j++)
			{
				if (i != 0 || j != 0)
				{
					SpriteBatch.DrawString(font, text, position.FloorV2() + new Vector2(i, j), Color.Black, 0f, origin, scale, SpriteEffects.None, 0f);
				}
			}
		}
		SpriteBatch.DrawString(font, text, position.FloorV2(), color, 0f, origin, scale, SpriteEffects.None, 0f);
	...
	public static void OutlineTextCentered(SpriteFont font, string text, Vector2 position, Color color, Color outlineColor)
	{
		...
		for (int i = -1; i < 2; i++)
		{
			for (int j = -1; j < 2; j++)
			{
				if (i != 0 || j != 0)
				{
					SpriteBatch.DrawString(font, text, position.FloorV2() + new Vector2(i, j), outlineColor, 0f, origin, 1f, SpriteEffects.None, 0f);
				}
			}
		}
		SpriteBatch.DrawString(font, text, position.FloorV2(), color, 0f, origin, 1f, SpriteEffects.None, 0f);
	...
	public static void OutlineTextCentered(SpriteFont font, string text, Vector2 position, Color color, Color outlineColor, float scale)
	{
		...
		for (int i = -1; i < 2; i++)
		{
			for (int j = -1; j < 2; j++)
			{
				if (i != 0 || j != 0)
				{
					SpriteBatch.DrawString(font, text, position.FloorV2() + new Vector2(i, j), outlineColor, 0f, origin, scale, SpriteEffects.None, 0f);
				}
			}
		}
		SpriteBatch.DrawString(font, text, position.FloorV2(), color, 0f, origin, scale, SpriteEffects.None, 0f);
