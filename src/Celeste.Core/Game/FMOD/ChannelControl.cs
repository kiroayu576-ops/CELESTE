...
public class ChannelControl : HandleBase
{
	public RESULT getSystemObject(out System system)
	{
		system = null;
		IntPtr system2;
		RESULT result = FMOD_ChannelGroup_GetSystemObject(rawPtr, out system2);
	...
	{
		return FMOD_ChannelGroup_SetMixLevelsOutput(rawPtr, frontleft, frontright, center, lfe, surroundleft, surroundright, backleft, backright);
	}
	...
	public RESULT getDSP(int index, out DSP dsp)
	{
		dsp = null;
		IntPtr dsp2;
		RESULT result = FMOD_ChannelGroup_GetDSP(rawPtr, index, out dsp2);
		dsp = new DSP(dsp2);
		return result;
	}
